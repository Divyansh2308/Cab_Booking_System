...
public class BookInterCityCab extends JFrame implements ActionListener{
	...
	BookInterCityCab()
	{
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("com/cab_booking/images/book_intercity.png"));
		...
		ch2.addMouseListener(new MouseAdapter()
		{
			public void mouseClicked(MouseEvent me)
			{
				try
				{
					...
					String q = "select * from intercity_driver where source = '"+source+"' and destination = '"+destination+"'";
					...
					while(rest.next())
					{
						...
						t8.setText(rest.getString("type"));
					}
				}
				catch(Exception e)
				{
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == b1)
		{
			...
			{
				ConnectionClass obj = new ConnectionClass();
				String q = "insert into intercity_cab values ('"+bid+"','"+username+"','"+name+"','"+dname+"','"+source+"','"+destination+"','"+type+"','"+car+"','"+price+"',";
