...
public class DeleteCustomer extends JFrame implements ActionListener{
	...
	DeleteCustomer()
	{
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("com/cab_booking/images/delete.jpg"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == b1)
		{
			...
			try
			{
				...
				String q1 = "delete from intercity_cab where username = '"+username+"'";
				String q2 = "delete from intracity_cab where username = '"+username+"'";
				String q3 = "delete from transport_package where username = '"+username+"'";
